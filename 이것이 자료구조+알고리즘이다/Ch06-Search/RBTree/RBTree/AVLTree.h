...
//--------------------------------------------------------------------
template <typename T>
void mylib_tree::AVLTree<T>::Insert(IN const T &key)
{
...
//--------------------------------------------------------------------
template <typename T>
void mylib_tree::AVLTree<T>::Delete(IN const T &key)
{
...
//--------------------------------------------------------------------
template <typename T>
mylib_tree::st_Node<T> *mylib_tree::AVLTree<T>::Search(IN const T &key)
{
...
//--------------------------------------------------------------------
template <typename T>
mylib_tree::st_Node<T> *mylib_tree::AVLTree<T>::Minimum(IN st_Node<T> *pNode)
{
	if (pNode == &m_NIL)
		return &m_NIL;
...
//--------------------------------------------------------------------
template <typename T>
mylib_tree::st_Node<T> *mylib_tree::AVLTree<T>::Maximum(IN st_Node<T> *pNode)
{
	if (pNode == &m_NIL)
		return &m_NIL;
...
//--------------------------------------------------------------------
template <typename T>
void mylib_tree::AVLTree<T>::PreOrderPrint()
{
...
//--------------------------------------------------------------------
template <typename T>
void mylib_tree::AVLTree<T>::InOrderPrint()
{
	std::wcout << L"InOrder:\t";
	InOrder(m_pRoot);
	std::wcout << L'\n';
...
//--------------------------------------------------------------------
template <typename T>
void mylib_tree::AVLTree<T>::PostOrderPrint()
{
...
//--------------------------------------------------------------------
template <typename T>
void mylib_tree::AVLTree<T>::PreOrder(IN st_Node<T> *pNode)
{
...
template <typename T>
void mylib_tree::AVLTree<T>::InOrder(IN st_Node<T> *pNode)
{
	if (pNode == &m_NIL || pNode == nullptr)
		return;
...
//--------------------------------------------------------------------
template <typename T>
void mylib_tree::AVLTree<T>::PostOrder(IN st_Node<T> *pNode)
{
	if (pNode == &m_NIL || pNode == nullptr)
		return;
...
//--------------------------------------------------------------------
template <typename T>
void mylib_tree::AVLTree<T>::Count()
{
...
//--------------------------------------------------------------------
template <typename T>
void mylib_tree::AVLTree<T>::Transplant(IN st_Node<T> *dPos, IN st_Node<T> *pNode)
{
...
//--------------------------------------------------------------------
template <typename T>
void mylib_tree::AVLTree<T>::LeftRotate(IN st_Node<T> *target)
{
...
//--------------------------------------------------------------------
template <typename T>
void mylib_tree::AVLTree<T>::RightRotate(IN st_Node<T> *target)
{
...
template <typename T>
int mylib_tree::AVLTree<T>::GetHeight(IN st_Node<T> *pNode)
{
	int lheight;
	int rheight;
...
template <typename T>
int mylib_tree::AVLTree<T>::GetBalanceFactor(IN st_Node<T> *pNode)
{
	int lsh;
	int rsh;
...
template <typename T>
void mylib_tree::AVLTree<T>::Rebalance()
{
